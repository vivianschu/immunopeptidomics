...
DATA     = HERE / "../circrna/data/ip/combined_peptide.tsv"
MSSTATS  = HERE / "../circrna/data/ip/msstats.csv"
OUT      = HERE / "qc_report.html"
...
def build_sample_page(s, figs):
    row = figs["stats"]
    return f"""<div class="container">
<div class="section">
  <h2>{s} \u2014 Summary</h2>
  <table class="stats-table small-table"><tbody>
    <tr><td>MS/MS detected</td><td><strong>{row['MS_MS']:,}</strong></td></tr>
    <tr><td>MBR detected</td><td><strong>{row['MBR']:,}</strong></td></tr>
    <tr><td>Total detected</td><td><strong>{row['Total_Detected']:,}</strong></td></tr>
    <tr><td>MBR rate</td><td><strong>{row['MBR_Rate']}</strong></td></tr>
    <tr><td>Contaminants</td><td><strong>{row['Contaminants']:,}</strong></td></tr>
    <tr><td>Contaminant rate</td><td><strong>{row['Contam_Rate']}</strong></td></tr>
  </tbody></table>
</div>
<div class="section">
...
for s in samples:
    ...
    sample_tab_contents += build_sample_page(s, sample_figs[s])
    sample_tab_contents += "\n</div>\n"
...
<div class="page-header">
  ...
  <p>FragPipe output &mdash; Neoantigen discovery pipeline &mdash; {len(samples)} samples</p>
</div>
